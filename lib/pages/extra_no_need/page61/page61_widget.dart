...
import 'page61_model.dart';
export 'page61_model.dart';

class Page61Widget extends StatefulWidget {
  const Page61Widget({super.key});

  @override
  State<Page61Widget> createState() => _Page61WidgetState();
}

class _Page61WidgetState extends State<Page61Widget> {
  late Page61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Page61Model());
  }

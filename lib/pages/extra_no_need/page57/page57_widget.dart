...
import 'page57_model.dart';
export 'page57_model.dart';

class Page57Widget extends StatefulWidget {
  const Page57Widget({super.key});

  @override
  State<Page57Widget> createState() => _Page57WidgetState();
}

class _Page57WidgetState extends State<Page57Widget> {
  late Page57Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Page57Model());
  }

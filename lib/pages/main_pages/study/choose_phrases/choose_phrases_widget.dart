...
import 'choose_phrases_model.dart';
export 'choose_phrases_model.dart';

class ChoosePhrasesWidget extends StatefulWidget {
  const ChoosePhrasesWidget({super.key});

  @override
  State<ChoosePhrasesWidget> createState() => _ChoosePhrasesWidgetState();
}

class _ChoosePhrasesWidgetState extends State<ChoosePhrasesWidget>
    with TickerProviderStateMixin {
  late ChoosePhrasesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChoosePhrasesModel());
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed('ChooseWords_noNeed');
                        },
                        child: Container(
                          width: 164.0,
                          height: 40.0,
